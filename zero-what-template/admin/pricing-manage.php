...
if ($_POST) {
    ...
    if ($action === 'update_pricing') {
        try {
            ...
            $pricing_data = [
                // Residential pricing
                'residential_base_price' => $_POST['residential_base_price'] ?? 0,
                'residential_price_per_kw' => $_POST['residential_price_per_kw'] ?? 0,
                'residential_subsidy_percentage' => $_POST['residential_subsidy_percentage'] ?? 0,
                // Commercial pricing
                'commercial_base_price' => $_POST['commercial_base_price'] ?? 0,
                'commercial_price_per_kw' => $_POST['commercial_price_per_kw'] ?? 0,
                'commercial_subsidy_percentage' => $_POST['commercial_subsidy_percentage'] ?? 0,
                // General settings
                'installation_cost_percentage' => $_POST['installation_cost_percentage'] ?? 15,
                'maintenance_annual_cost' => $_POST['maintenance_annual_cost'] ?? 5000,
                'warranty_years' => $_POST['warranty_years'] ?? 25,
                'payback_period_years' => $_POST['payback_period_years'] ?? 7
            ];
...
$currentPricing = [];
$settings = $db->fetchAll("SELECT setting_key, setting_value FROM site_settings WHERE setting_key LIKE '%price%' OR setting_key LIKE '%subsidy%' OR setting_key LIKE '%cost%' OR setting_key LIKE '%years%'");
foreach ($settings as $setting) {
    $currentPricing[$setting['setting_key']] = $setting['setting_value'];
}

// Function to get pricing value with default
function getPricing($key, $default = 0) {
    global $currentPricing;
    return $currentPricing[$key] ?? $default;
}
?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="residential_base_price" name="residential_base_price" 
                                           value="<?php echo getPricing('residential_base_price', 50000); ?>" min="0" step="1000">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="residential_price_per_kw" name="residential_price_per_kw" 
                                           value="<?php echo getPricing('residential_price_per_kw', 50000); ?>" min="0" step="1000">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="residential_subsidy_percentage" name="residential_subsidy_percentage" 
                                           value="<?php echo getPricing('residential_subsidy_percentage', 30); ?>" min="0" max="100" step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="commercial_base_price" name="commercial_base_price" 
                                           value="<?php echo getPricing('commercial_base_price', 100000); ?>" min="0" step="1000">
                                    <div class="form-text">Fixed installation cost</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="commercial_price_per_kw" name="commercial_price_per_kw" 
                                           value="<?php echo getPricing('commercial_price_per_kw', 45000); ?>" min="0" step="1000">
                                    <div class="form-text">Cost per kilowatt</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="commercial_subsidy_percentage" name="commercial_subsidy_percentage" 
                                           value="<?php echo getPricing('commercial_subsidy_percentage', 20); ?>" min="0" max="100" step="1">
                                    <div class="form-text">Government subsidy percentage</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="installation_cost_percentage" name="installation_cost_percentage" 
                                           value="<?php echo getPricing('installation_cost_percentage', 15); ?>" min="5" max="30" step="1">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="maintenance_annual_cost" name="maintenance_annual_cost" 
                                           value="<?php echo getPricing('maintenance_annual_cost', 5000); ?>" min="0" step="500">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="warranty_years" name="warranty_years" 
                                           value="<?php echo getPricing('warranty_years', 25); ?>" min="10" max="30" step="1">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="payback_period_years" name="payback_period_years" 
                                           value="<?php echo getPricing('payback_period_years', 7); ?>" min="3" max="15" step="0.5">
