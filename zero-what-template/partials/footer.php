    ...
    <div class="container text-center text-md-start">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
                ...
                <p>Jaipur's most trusted partner in solar energy solutions. We are an authorized partner of the Government of India's Rooftop Solar Programme, committed to powering Rajasthan's future.</p>
            </div>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="pricing.php" class="text-white text-decoration-none">Pricing</a></p>
                <p><a href="projects.php" class="text-white text-decoration-none">Our Work</a></p>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p><a href="blog.php" class="text-white text-decoration-none">Solar Blog</a></p>
                <p><a href="subsidy.php" class="text-white text-decoration-none">Subsidy Info</a></p>
                <p><a href="blog-detail.php?id=1" class="text-white text-decoration-none">Installation Guide</a></p>
                <p><a href="blog-detail.php?id=2" class="text-white text-decoration-none">Government Subsidy</a></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form id="popupQuoteForm" action="process-form.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="popupPhone" name="phone" pattern="[0-9]{10}" placeholder="10-digit mobile number" required>
                            </div>
                            <div class="mb-3">
...
<script src="https://kit.fontawesome.com/9a2b5a4b5b.js" crossorigin="anonymous"></script>
