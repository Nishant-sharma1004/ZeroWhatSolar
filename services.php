<?php 
    ...
    try {
        ...
        $servicesQuery = "SELECT * FROM services WHERE status = 'active' ORDER BY service_order, id";
        $services = $db->fetchAll($servicesQuery);
...
<section class="section-padding">
    <div class="container">
        <h2 class="section-title"><?php echo htmlspecialchars($settings['services_title'] ?? 'Complete Solar Solutions for Every Need'); ?></h2>
        <p class="section-subtitle"><?php echo htmlspecialchars($settings['services_subtitle'] ?? 'From residential rooftops to large industrial installations, we provide end-to-end solar solutions with guaranteed performance and maximum savings.'); ?></p>
            ...
            <?php if (!empty($services)): ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        <div class="icon"><i class="<?php echo htmlspecialchars($service['icon'] ?? 'fas fa-solar-panel'); ?>"></i></div>
                        ...
                        <div class="mt-3">
                            ...
                            <span class="badge bg-<?php echo $service['price_type'] === 'starting' ? 'success' : ($service['price_type'] === 'custom' ? 'warning text-dark' : 'primary'); ?>">
                                <?php echo htmlspecialchars($service['price_display']); ?>
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <?php else: ?>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <p class="mb-3">Transform your home into a power station with our premium residential solar solutions.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <p class="mb-3">Large-scale solar installations for manufacturing units and industrial complexes.</p>
                        <div class="mt-3">
        ...
        <!-- Additional Services -->
        <h3 class="text-center mb-4 text-primary"><?php echo htmlspecialchars($settings['additional_services_title'] ?? 'Additional Services'); ?></h3>
        <div class="row g-4">
            <?php 
            ...
            <?php if (!empty($additionalServices)): ?>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-card h-100">
                        <div class="icon"><i class="<?php echo htmlspecialchars($service['icon'] ?? 'fas fa-cog'); ?>"></i></div>
            ...
            <?php else: ?>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-card h-100">
                        ...
                        <p>Complete documentation and government subsidy claim processing with guaranteed approval.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="service-card h-100">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-card h-100">
                        ...
                        <p>Zero down payment options, easy EMIs, and flexible financing to make solar affordable.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
                ...
                <div class="card shadow border-0">
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Get personalized recommendations and pricing for your solar project</p>
                        </div>
                        
                        <form action="process-form.php" method="POST" id="serviceInquiryForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" id="servicePhone" name="phone" pattern="[0-9]{10}" placeholder="10-digit mobile number" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="serviceMessage" name="message" rows="3" placeholder="Tell us about your energy needs, project requirements, or any specific questions about our services..."></textarea>
                                </div>
                                <div class="col-12 text-center">
                                    ...
                                    <p class="text-muted mt-2 mb-0">
                                        <small><i class="fas fa-clock me-1"></i>Our service specialist will contact you within 1 hour</small>
                                    </p>
                                </div>
                            </div>
                        </form>
