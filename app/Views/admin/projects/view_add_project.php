...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Add/Edit Form -->
        <form id="add_project" name="add_project" enctype="multipart/form-data" action="save-project">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="system_size_kw"
                                name="system_size_kw" value="" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="featured_image" name="featured_image" accept=".jpg, .jpeg, .png, .webp, .avif">
                        </div>
                    </div>
                </div>
