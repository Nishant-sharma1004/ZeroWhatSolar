...
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo ASSETS_PATH; ?>images/apple-touch-icon.png">
...
<!-- Custom CSS -->
<link rel="stylesheet" href="<?php echo ASSETS_PATH . 'css/style.css?rand=' . RAND; ?>">
