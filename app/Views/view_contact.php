                        ...
                        <form action="process-form.php" method="POST" id="InquiryForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    placeholder="Your area/locality in Jaipur">
                            </div>
                            <div class="mb-3">
                                <label for="message" class="form-label">Additional Requirements</label>
                                <textarea class="form-control" id="message" name="message" rows="4"
                                    placeholder="Any specific requirements or questions about solar installation..."></textarea>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-lg w-100">🚀 Get My FREE Solar
                                Quote</button>
                            <small class="text-muted mt-2 d-block text-center">Our solar experts will contact you within
                                2 hours</small>
                        </form>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="mb-4 p-3 bg-light rounded">
                                ...
                                <a href="tel:+919876543210" class="btn btn-outline-success btn-sm">📱 +91 987 654
                                    3210</a><br>
